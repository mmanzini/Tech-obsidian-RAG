...
sources:
- id: youtube-chase-ai-claude-code-agentic-os-unstoppable
  resource: YouTube — Chase AI, "Claude Code Agentic OS = UNSTOPPABLE"
generated:
...
- ai-engineering/harness-engineering/agentic-os-eight-components.md
