...
This repository is a public mirror of one bundle from a personal Obsidian RAG vault (Atlas). Articles are distilled from primary sources — talks, papers, reporting, essays, podcasts, original analysis — into concise, cross-linked notes with inline source citations. It currently holds **189 articles across 23 topics**.
...
- [Claude Code Practice](claude-code-practice/) — Claude Code features, workflows, and session management: routines, desktop parallel sessions, Agent View, dynamic workflows, effort/model selection, Opus 4.7 tuning, structured memory, Cowork guides, Managed Agents memory, Agentic OS three-gap framework
...
- [Engineering Leader Interviews](engineering-leader-interviews/) — Per-guest takeaway digests from engineering leaders and hands-on builders shipping through coding agents (Dhanji Prasanna, Scott Wu, Sherwin Wu, Lazar Jovanovic, Zevi Arnovitz)
