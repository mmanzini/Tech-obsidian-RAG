...
This topic is the **deep reference** for RPI. For the one-page overview see [[agent-workflows/research-plan-implement|Research-Plan-Implement]] in agent-workflows.
